...
const LANDSCAPE_SCENES = [
  ...
  { id: 'landscape_rain_curtain', labelEN: 'Rain Curtain Feature', labelTH: 'ม่านน้ำตกแต่ง', prompt: 'A mesmerizing modern garden water feature, a large semi-circular rain curtain falling from a tall dark metal structure into a shallow circular stone basin. The water droplets are backlit by warm golden hour sunlight, creating a glistening and sparkling effect. The ground is paved with dark slate tiles. Lush tall trees and bamboo in the background create deep shadows and contrast. Serene, zen-like atmosphere, high shutter speed photography to freeze water droplets, 8k resolution.' }
];
